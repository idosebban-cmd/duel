      ...
      {open && imageSrc && (
        ...
        >
          ...
          >
            ...
            <p className="font-body text-ui-body mb-3" style={{ color: 'rgba(255,255,255,0.55)' }}>
              Drag to adjust framing, zoom to get closer, then confirm.
            </p>

            <p className="font-body text-ui-body font-bold mb-2 text-center" style={{ color: '#4EFFC4' }}>
            ...
            <div className="mt-3">
              <label className="font-body text-ui-body" style={{ color: 'rgba(255,255,255,0.55)' }}>
                Zoom
              </label>
              <input
                type="range"
            ...
            <div className="mt-4 flex gap-3">
              <button
                onClick={onCancel}
                className="flex-1 h-11 rounded-xl font-body text-ui-body font-bold"
              ...
              <button
                ...
                className={`flex-1 h-11 rounded-xl font-body text-ui-body font-bold ${busy || !naturalSize ? 'opacity-40 cursor-not-allowed pointer-events-none' : ''}`}
                style={{
