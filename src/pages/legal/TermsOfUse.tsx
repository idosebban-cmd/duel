...
We are Noble Banana Ltd ("Company," "we," "us," "our"). We operate playduel.app, as well as any other related products and services that refer or link to these legal terms (the "Legal Terms") (collectively, the "Services").

You can contact us by email at ido@noblebanana.com or by mail to Noble Banana Ltd, 19 Lynbrook Grove, London, SE15 6HN, United Kingdom.

These Legal Terms constitute a legally binding agreement made between you, whether personally or on behalf of an entity ("you"), and Noble Banana Ltd, concerning your access to and use of the Services. You agree that by accessing the Services, you have read, understood, and agreed to be bound by all of these Legal Terms. IF YOU DO NOT AGREE WITH ALL OF THESE LEGAL TERMS, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SERVICES AND YOU MUST DISCONTINUE USE IMMEDIATELY.
...
If you wish to make any use of the Services, Content, or Marks other than as set out in this section, please address your request to: ido@noblebanana.com.
...
- Send unsolicited messages, spam, or harass other users
- Impersonate another person or create a false identity
- Upload false, misleading, or inappropriate profile information or photos
...
These Legal Terms shall remain in full force and effect while you use the Services. WE RESERVE THE RIGHT TO, IN OUR SOLE DISCRETION AND WITHOUT NOTICE OR LIABILITY, DENY ACCESS TO AND USE OF THE SERVICES TO ANY PERSON FOR ANY REASON, INCLUDING WITHOUT LIMITATION FOR BREACH OF ANY REPRESENTATION, WARRANTY, OR COVENANT CONTAINED IN THESE LEGAL TERMS. WE MAY TERMINATE YOUR USE OR PARTICIPATION IN THE SERVICES OR DELETE ANY CONTENT OR INFORMATION THAT YOU POSTED AT ANY TIME, WITHOUT WARNING, IN OUR SOLE DISCRETION.
...
These Legal Terms shall be governed by and defined following the laws of England and Wales. Noble Banana Ltd and yourself irrevocably consent that the courts of England and Wales shall have exclusive jurisdiction to resolve any dispute which may arise in connection with these Legal Terms.
...
Any dispute arising out of or in connection with these Legal Terms shall be referred to and finally resolved by the International Commercial Arbitration Court under the European Arbitration Chamber (Belgium, Brussels, Avenue Louise, 146). The seat of arbitration shall be London, England. The language of the proceedings shall be English. The governing law shall be the substantive law of England and Wales.
...
export function TermsOfUse() {
  ...
  const paragraphs = useMemo(() => splitParagraphs(TERMS_TEXT), []);
        ...
        >
          ...
          <div className="flex flex-col gap-3">
            {paragraphs.map((p, idx) => {
              const isSectionHeading = /^\d+\.\s/.test(p) || p === p.toUpperCase();
              if (isSectionHeading) {
                return (
                  <h2
                    key={idx}
