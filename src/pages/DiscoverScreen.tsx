...
const PROFILES: Profile[] = [
  { id: 1,  name: 'Zara',   age: 26, location: 'Shoreditch',        distance: '0.8 mi', distanceKm: 1.3,  character: 'fox',     element: 'fire',     affiliation: 'art',      bio: "Muralist by day, trivia queen by night. Will destroy you at board games then buy you a pint. Looking for someone who isn't afraid to lose with dignity.",              games: ['trivia', 'drawing', 'party'],    lookingFor: 'casual',     willMatch: true,  duelGames: ['guess-who', 'word-blitz'],              activityLevel: 'today', kids: 'Not sure yet',  drinking: 'Socially', smoking: 'Never',    cannabis: 'Sometimes', pets: 'Cat',  exercise: 'Rarely',    favoriteGames: ['Scrabble', 'Codenames'], intent: 'both' },
  ...
  { id: 15, name: 'Yuki',   age: 23, location: 'Shoreditch',        distance: '0.6 mi', distanceKm: 1.0,  character: 'ninja',   element: 'air',      affiliation: 'cosmic',   bio: "UX designer and astrology sceptic who reads their chart every single day. I'm very fast at reaction games and very slow at making decisions about my feelings. Mercury in retrograde, obviously.", games: ['video', 'party', 'puzzles'],     lookingFor: 'not-sure',   willMatch: false, duelGames: ['dot-dash', 'word-blitz', 'guess-who'],  activityLevel: 'today', kids: 'Not sure yet',  drinking: 'Socially', smoking: 'Never',    cannabis: 'Sometimes', pets: 'Cat',  exercise: 'Sometimes', favoriteGames: ['Beat Saber', 'Tetris'], intent: 'both' },
